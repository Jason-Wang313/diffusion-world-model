...
## JEPA / Latent Best-of-N

Latent Best-of-N studies ranking in representation space and latent-real distortion. This repository uses explicit generated future states and measures imagined score against real rollout utility.

## Best-of-N WAM

The WAM connection is theoretical: finite Best-of-N selection laws apply to any score/utility pool. The empirical focus here is diffusion-world-model selection, especially generated future tails, denoising budget, mode collapse, plausibility bias, and uncertainty-aware repair.
